...
function SpecialSnowflakesConfig () {
	return {
		...
		'framerate': 20,   // This is a maximum, we will adjust downward if the user's browser can't keep up
		'cpuLimit' : 0.5,// If the render time rises above this threshold, we will reduce the framerate -- this VERY loosely correlates with CPU %
		...
		'glowMin'  : 0, // How wide the "glow" on the least shiny snowflake should be
		'glowMax'  : 0, // How wide the "glow" on the most shiny snowflake should be
		'flakes'   : ['*'], // The set of characters or strings to use as snowflakes
		'canvas'   : "container", // HTML ID of the element you wish to snow on - null for HTML body or window
